    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 bg-gray-50">
      <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center animate-fade-in">
        ...
        <button
          ...
          className="w-full bg-brand-red hover:bg-red-700 text-white font-semibold py-3 px-6 rounded-xl transition-all hover:shadow-lg flex items-center justify-center gap-3"
        >
        ...
        <p className="text-xs text-gray-400 mt-6">
          Alleen voor leerlingen en leerkrachten van GO! atheneum Gentbrugge
        </p>
      </div>
    </div>
  );
